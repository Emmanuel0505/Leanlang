...
export default function RegisterPage() {
  ...
  return (
    <AuthShell>
      ...
      <p className="mt-1.5 text-sm text-slate-500">Gratis. Empieza a diseñar tu validación en minutos.</p>
      ...
      <form onSubmit={onSubmit} className="mt-8 space-y-4">
        ...
        {error && (
          <p id="auth-error" role="alert" className="rounded-lg bg-rose-500/10 px-3 py-2 text-sm text-rose-700 dark:text-rose-300">{error}</p>
        )}
