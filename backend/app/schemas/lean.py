...
class Problem(BaseModel):
    ...
    context: str = Field(description="Situacion/contexto en que aparece el problema")
...
class CustomerSegment(BaseModel):
    ...
    description: str = Field(description="Descripcion del segmento")
    ...
    early_adopters: str = Field(default="", description="Quienes adoptarian primero")
...
class ValueProposition(BaseModel):
    ...
    differentiator: str = Field(default="", description="Que la hace distinta de las alternativas")
